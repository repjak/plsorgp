...
% Benchmarking of Ordinal Regression>. Each dataset has been randomly
% divided into training and testing data in 20 repetitions for two
% discretizations of the output space: into 5 and 10 bins.
...
% random repetitions. The following performance measures are
